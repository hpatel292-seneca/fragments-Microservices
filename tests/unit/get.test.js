...
describe('GET /v1/fragments/:id.ext', () => {
  ...
  describe('CSV Fragments should be converted successfully', () => {
    test('CSV fragment should successfully converted to txt', async () => {
      // post a fragment
      const filePath = path.join(__dirname, '..', 'files', 'file.csv');
      const fileContent = fs.readFileSync(filePath, 'utf8');
      const ownerId = hash('user1@email.com');
  ...
  describe('JSON Fragments should be converted successfully', () => {
    ...
    test('JSON fragment should successfully converted to .yml', async () => {
      // post a fragment
      const filePath = path.join(__dirname, '..', 'files', 'file.json');
      const fileContent = fs.readFileSync(filePath, 'utf8');
      const ownerId = hash('user1@email.com');
    ...
    test('JSON fragment should successfully converted to .txt', async () => {
      // post a fragment
      const filePath = path.join(__dirname, '..', 'files', 'file.json');
      const fileContent = fs.readFileSync(filePath, 'utf8');
      const ownerId = hash('user1@email.com');
  ...
  describe('YAML Fragments should be converted successfully', () => {
    test('YAML fragment should successfully converted to .txt', async () => {
      // post a fragment
      const filePath = path.join(__dirname, '..', 'files', 'file.yaml');
      const fileContent = fs.readFileSync(filePath, 'utf8');
      const ownerId = hash('user1@email.com');
  ...
  describe('PNG Fragments should be converted successfully', () => {
    test('PNG fragments data should converted to .jpg', async () => {
      // post a fragment
      const filePath = path.join(__dirname, '..', 'files', 'file.png');
      const fileContent = fs.readFileSync(filePath);
      const ownerId = hash('user1@email.com');
      ...
      const receivedMetadata = await sharp(receivedFileContent).metadata();
      const originalContent = await sharp(fileContent).jpeg().toBuffer();

      expect(receivedMetadata.format).toBe('jpeg');
      expect(Buffer.compare(receivedFileContent, originalContent)).toBe(0);
    });

    test('PNG fragments data should converted to .webp', async () => {
      // post a fragment
      const filePath = path.join(__dirname, '..', 'files', 'file.png');
      const fileContent = fs.readFileSync(filePath);
      const ownerId = hash('user1@email.com');
    ...
    test('PNG fragments data should converted to .gif', async () => {
      // post a fragment
      const filePath = path.join(__dirname, '..', 'files', 'file.png');
      const fileContent = fs.readFileSync(filePath);
      const ownerId = hash('user1@email.com');
    ...
    test('PNG fragments data should converted to .avif', async () => {
      // post a fragment
      const filePath = path.join(__dirname, '..', 'files', 'file.png');
      const fileContent = fs.readFileSync(filePath);
      const ownerId = hash('user1@email.com');
  ...
  describe('JPEG Fragments should be converted successfully', () => {
    test('JPEG fragments data should converted to .png', async () => {
      // post a fragment
      const filePath = path.join(__dirname, '..', 'files', 'file.jpeg');
      const fileContent = fs.readFileSync(filePath);
      const ownerId = hash('user1@email.com');
    ...
    test('JPEG fragments data should converted to .webp', async () => {
      // post a fragment
      const filePath = path.join(__dirname, '..', 'files', 'file.jpeg');
      const fileContent = fs.readFileSync(filePath);
      const ownerId = hash('user1@email.com');
    ...
    test('JPEG fragments data should converted to .gif', async () => {
      // post a fragment
      const filePath = path.join(__dirname, '..', 'files', 'file.jpeg');
      const fileContent = fs.readFileSync(filePath);
      const ownerId = hash('user1@email.com');
  ...
  describe('WEBP Fragments should be converted successfully', () => {
    test('WEBP fragments data should converted to .png', async () => {
      // post a fragment
      const filePath = path.join(__dirname, '..', 'files', 'file.webp');
      const fileContent = fs.readFileSync(filePath);
      const ownerId = hash('user1@email.com');
    ...
    test('WEBP fragments data should converted to .jpg', async () => {
      // post a fragment
      const filePath = path.join(__dirname, '..', 'files', 'file.webp');
      const fileContent = fs.readFileSync(filePath);
      const ownerId = hash('user1@email.com');
    ...
    test('WEBP fragments data should converted to .avif', async () => {
      // post a fragment
      const filePath = path.join(__dirname, '..', 'files', 'file.webp');
      const fileContent = fs.readFileSync(filePath);
      const ownerId = hash('user1@email.com');
  ...
  describe('avif Fragments should be converted successfully', () => {
    test('AVIF fragments data should converted to .png', async () => {
      // post a fragment
      const filePath = path.join(__dirname, '..', 'files', 'file.avif');
      const fileContent = fs.readFileSync(filePath);
      const ownerId = hash('user1@email.com');
    ...
    test('AVIF fragments data should converted to .jpg', async () => {
      // post a fragment
      const filePath = path.join(__dirname, '..', 'files', 'file.avif');
      const fileContent = fs.readFileSync(filePath);
      const ownerId = hash('user1@email.com');
    ...
    test('AVIF fragments data should converted to .webp', async () => {
      // post a fragment
      const filePath = path.join(__dirname, '..', 'files', 'file.avif');
      const fileContent = fs.readFileSync(filePath);
      const ownerId = hash('user1@email.com');
    ...
    test('AVIF fragments data should converted to .gif', async () => {
      // post a fragment
      const filePath = path.join(__dirname, '..', 'files', 'file.avif');
      const fileContent = fs.readFileSync(filePath);
      const ownerId = hash('user1@email.com');
  ...
  describe('GIF Fragments should be converted successfully', () => {
    ...
    test('GIF fragments data should converted to .jpg', async () => {
      // post a fragment
      const filePath = path.join(__dirname, '..', 'files', 'file.gif');
      const fileContent = fs.readFileSync(filePath);
      const ownerId = hash('user1@email.com');
    ...
    test('GIF fragments data should converted to .webp', async () => {
      // post a fragment
      const filePath = path.join(__dirname, '..', 'files', 'file.gif');
      const fileContent = fs.readFileSync(filePath);
      const ownerId = hash('user1@email.com');
    ...
    test('GIF fragments data should converted to .avif', async () => {
      // post a fragment
      const filePath = path.join(__dirname, '..', 'files', 'file.gif');
      const fileContent = fs.readFileSync(filePath);
      const ownerId = hash('user1@email.com');
